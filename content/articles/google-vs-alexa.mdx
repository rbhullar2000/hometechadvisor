...
<table className="table-auto w-full text-left border-collapse border border-gray-300">
  <thead>
    <tr>
      <th className="border border-gray-300 px-4 py-2 bg-gray-100 font-semibold">Category</th>
      <th className="border border-gray-300 px-4 py-2 bg-gray-100 font-semibold">Winner</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td className="border border-gray-300 px-4 py-2">Device Compatibility</td>
      <td className="border border-gray-300 px-4 py-2">Alexa</td>
    </tr>
    <tr>
      <td className="border border-gray-300 px-4 py-2">Voice Recognition</td>
      <td className="border border-gray-300 px-4 py-2">Google</td>
    </tr>
    <tr>
      <td className="border border-gray-300 px-4 py-2">Automation Features</td>
      <td className="border border-gray-300 px-4 py-2">Alexa</td>
    </tr>
    <tr>
    ...
    <tr>
      <td className="border border-gray-300 px-4 py-2">App Usability</td>
      <td className="border border-gray-300 px-4 py-2">Google</td>
    </tr>
    <tr>
      <td className="border border-gray-300 px-4 py-2">Hardware Ecosystem</td>
      <td className="border border-gray-300 px-4 py-2">Tie</td>
    </tr>
    <tr>
      <td className="border border-gray-300 px-4 py-2">Platform Integration</td>
      <td className="border border-gray-300 px-4 py-2">Depends on user</td>
    </tr>
  </tbody>
</table>
